...
# smem_gemm_blocktiling_1d(TILE_SIZE_X 32, TILE_SIZE_Y 8, TM 4)         0.26752 ms
# smem_gemm_blocktiling_1d(TILE_SIZE_X 32, TILE_SIZE_Y 4, TM 8)         0.244352 ms
# smem_gemm_blocktiling_1d(TILE_SIZE_X 32, TILE_SIZE_Y 4, TM 16)        0.239968 ms
# smem_gemm_blocktiling_1d(TILE_SIZE_X 64, TILE_SIZE_Y 8, TM 8)         0.258272 ms
# smem_gemm_blocktiling_1d(TILE_SIZE_X 64, TILE_SIZE_Y 4, TM 16)        0.253568 ms

# smem_gemm_blocktiling_2d(TILE_SIZE_X 8,  TILE_SIZE_Y 8, TN = 4, TM 4)        0.2384 ms
# smem_gemm_blocktiling_2d(TILE_SIZE_X 16, TILE_SIZE_Y 16,TN = 4, TM 4)        0.230208 ms
# smem_gemm_blocktiling_2d(TILE_SIZE_X 16, TILE_SIZE_Y 8, TN = 4, TM 8)        0.233952 ms
# smem_gemm_blocktiling_2d(TILE_SIZE_X 8,  TILE_SIZE_Y 16, TN = 8, TM 4)       0.317792 ms


# Load the CUDA kernel as a python module
# os.environ['TORCH_CUDA_ARCH_LIST'] = '8.6'  # 根据你的 GPU 架构调整
custom_gemm = load(name='custom_gemm', sources=['main.cpp', 'gemm.cu'], extra_cuda_cflags=['-O2'])
